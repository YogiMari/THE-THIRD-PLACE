...
PX-005 Acquisition Handbookは、PX-004 Barista Codexで正式採用されたCoffee Equipmentについて、購入・調達に関する情報を管理する正式文書である。  
...
ただし、Coffee Systemにおける「必要なEquipment」と「追加購入が必要なEquipment」を明確に区別する。  
...
購入対象を抽出する場合は、原則として `Acquisition Status = Purchase Required` のEquipmentのみを購入対象とする。  
...
海外製品については、必要に応じて以下を含めた日本到着時の総額を確認する。  
...
| Model | Chisel Redistribution Tool Wood (53 mm Custom Order) |  
...
| Quantity | 1 |  
| Purchase Type | Included with Machine |  
...
| Model | Master Kit (Module A + Module B) |  
...
|---|---|  
| Manufacturer | WPM |  
| Model | Handleless Pitcher Standard |  
...
* Color: Black  
* One coaster used as separator  
* Remaining coaster retained as spare  
* Used between PROPEL and AERESSO  
* No case modification  
...
| Quantity | 2 |  
| Purchase Type | Domestic |  
| Primary Purchase Source | CATAPULT FACTORY Official Store |  
| Purchase URL | To Be Confirmed |  
| Japan Shipping | Available |  
| Warranty | Manufacturer Policy |  
| Product Price | To Be Confirmed |  
...
* Confirmed Equipment  
* Capacity: 540 mL  
* Additional Coffee System Water capacity  
...
| Product | Quantity | Capacity | Acquisition Status |  
|---|---:|---:|---|  
| Snow Peak オーロラボトル 1L | 1 | 1,000 mL | Purchase Required |  
| YETI Yonder 1L | 1 | 1,000 mL | Purchase Required |  
| Snow Peak 酒筒 Titanium | 1 | 540 mL | Purchase Required |  
| **Total** | **3** | **2,540 mL** | **Confirmed** |  
  
These containers are dedicated to:  
...
No hard case is required.  
  
No case modification is required.  
...
The Stainless Steel Basket Cap Pro is a required component of the confirmed 9Barista workflow.  
  
However, it is included with the 9Barista Mk.2 Pro.  
...
6. Product name matches PX-004 official naming.  
...
PX-005 Acquisition Handbook is the acquisition authority for Confirmed Equipment.  
  
PX-005 must not independently add alternative equipment.  
  
PX-005 must not remove a Confirmed Equipment item merely because it does not require a separate purchase.  
