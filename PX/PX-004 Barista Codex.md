...
Weber Workshops Blind Shaker Onyxを正式採用する。  
  
THE THIRD PLACEのCoffee Systemにおける標準Blind Shakerとする。  
  
Selection Priority  
  
Blind Shakerの選定では、以下の優先順位を採用した。  
  
1. Size / Physical Compatibility  
2. Brandの世界的評価 Tier A以上  
3. Workflow  
4. Design / Color  
5. Material  
  
色味については、Tier A以上のブランドであれば多少の色調差を許容する。  
...
* LAGOM Miniから粉を安全に受けられること  
* 直接受けが成立しない場合は純正Ground Transfer Cupを使用できること  
* 粉が受け口からはみ出さないこと  
* 粉を無駄なく移送できること  
  
9Barista Side  
  
* 9Barista 53 mm Workflowで使用できること  
* 9Barista Magnetic Dosing Funnelへ粉を移送できること  
* ファンネル外へ粉がはみ出さないこと  
* 53 mmの9Barista環境で実用上問題なく使用できること  
  
Selection Criteria  
  
* Size / Physical Compatibility  
* Brand Tier  
* Workflow  
* Design  
* Color  
...
* LAGOM Mini Workflow Compatibility  
...
Blind ShakerにはOnyxカラーが存在することを確認した。  
  
Black / Onyx系の外観を優先し、Onyxを正式仕様とする。  
  
Physical Dimensions  
  
確認できた寸法：  
  
* Outer Diameter：約75 mm  
* Height：約70–76 mm  
* Material：Anodized Aluminum  
* Intended Basket Size：58 mm  
...
* Three internal fins  
* Convex bottom  
* Headspace designed to concentrate aroma  
* Swirling designed to mix espresso layers  
...
Recommended Espresso Dose  
  
Up to approximately 45ml  
...
* Transport only the two glass espresso cups  
* PROPEL and AERESSO are intended to be stored vertically/nested inside one case  
  
Storage Concept  
  
* PROPEL positioned below  
* AERESSO positioned above and partially nested into PROPEL  
* This reduces the combined storage height from approximately 150mm  
...
Category	Brand	Model	Status  
Glass Separator	AION Plus	Seine Super Absorbent Coaster 801-BL	Confirmed  
...
* KRUVE PROPEL ×1  
* AERESSO ×1  
* AION 2mm coaster ×1 as separator  
...
The two people can experience the same 9Barista espresso through two different purpose-designed sensory vessels:  
  
* PROPEL = espresso layer integration / controlled sensory experience  
* AERESSO = aeration / aroma and flavor opening  
...
Urban Dosing Grounds — Blind Tumbler  
...
デザイン面では非常に魅力的であり、ブラック＋ウォルナットという素材構成もTHE THIRD PLACEとの親和性が高かった。  
...
を総合すると、Weber Workshopsを上回らなかった。  
  
⸻  
  
Sworks Design — Shaker Funnel  
...
Craig Lyn Design Studio — ESF II  
...
* Glass Separator — AION Plus Seine Super Absorbent Coaster 801-BL ×1 package  
...
PROPELとAERESSOの間にはAION Plus Seine Super Absorbent Coaster 801-BLを1枚使用し、直接のガラス接触を防止する。  
