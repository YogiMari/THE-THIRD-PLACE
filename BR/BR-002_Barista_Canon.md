...
DAMNGOOD × CATAPULT FACTORY FIKA12を2個使用する。    
...
Grounds Dosing Cupを追加しても、既存Workflowに対する品質向上がない。  
...
Saint Anthony Industries The BlocがKnock Box機能を統合している。  
...
Not Separately Acquired  
  
### Reason  
  
9Barista Stainless Steel Basket Cap Proは9Barista Mk.2 Proの標準付属品として使用する。  
  
そのため、Coffee Systemの独立Equipmentとして管理せず、MD-004 Equipment RegistryおよびBR-003 Procurement Handbookの独立項目には含めない。  
...
MantaBrew Master Kit (Module A + Module B)を正式採用した。  
  
Master Kit以外の追加Scale Moduleは、現時点のCoffee Systemに必要としない。  
...
- THE THIRD PLACEのDesign Principlesと整合すること  
- Workflowを改善すること  
- Workflowを複雑化させないこと  
- Long-term Ownershipを考慮すること  
- Portable Luxuryを維持すること  
- Functional Beautyを備えること  
- Repairability / Maintainabilityを考慮すること  
- 必要以上にEquipmentを増やさないこと  
...
Coffee Equipmentに関する正式決定は、**BR-002 Barista Canon**を基準とする。  
  
BR-002でConfirmedされたEquipmentは、MD-004 Equipment Registryへ反映し、調達情報についてはBR-003 Procurement Handbookで管理する。  
